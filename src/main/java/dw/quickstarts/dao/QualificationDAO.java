...
public interface QualificationDAO {
    ...
    @SqlUpdate("update qualifications set qualification = :qualification where id = :id")
    void updateQualification(@Bind("id") Long id, @Bind("qualification") String qualification);

    @SqlUpdate("delete from qualifications where id = :id")
    void deleteQualification(@Bind("id") Long id);
}
